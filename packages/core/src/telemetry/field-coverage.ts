...
export const TASK_COMPLETED_FIELD_COVERAGE: Record<string, FieldCoverage> = {
  ...
  capabilities:             { kind: 'constant', reason: 'SCHEMA_VERSION 4 deprecated-fields constant (buildWirePayload)' },
  ...
  parentModel:              { kind: 'derived', source: 'BuildContext.mainModel (normalized)' },
  parentModelFamily:        { kind: 'derived', source: 'BuildContext.mainModel (normalized)' },
  ...
  parentEquivalentCostUSD:  { kind: 'derived', source: 'priceTokens(sumTokens(stages), resolveRateCard(mainModel))' },
  ...
  clarificationRequested:   { kind: 'constant', reason: 'SCHEMA_VERSION 4 deprecated-fields constant (buildWirePayload)' },
  briefQualityWarningCount: { kind: 'constant', reason: 'SCHEMA_VERSION 4 deprecated-fields constant (buildWirePayload)' },
