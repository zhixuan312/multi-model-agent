...
export const TASK_COMPLETED_FIELD_COVERAGE: Record<string, FieldCoverage> = {
  ...
  cachedCreationTokens:     { kind: 'derived', source: 'sum(stages[].cachedCreationTokens)' },
...
const COMMON_STAGE_COVERAGE: Record<string, FieldCoverage> = {
  ...
  cachedCreationTokens:{ kind: 'derived', source: 'stageStats[name].cachedCreationTokens' },
...
export const STAGE_FIELD_COVERAGE: Record<string, Record<string, FieldCoverage>> = {
  ...
  verifying: {
    ...
    cachedCreationTokens:{ kind: 'constant', reason: 'verify runs shell commands, not LLM — no tokens' },
  ...
  committing: {
    ...
    cachedCreationTokens:{ kind: 'constant', reason: 'commit stage runs git commands, not LLM — no tokens' },
