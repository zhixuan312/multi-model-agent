...
export const qualityAPTemplate: ReviewerTemplate = {
  build({ artifact, brief }) {
    return [
      'You are reviewing an audit-point (AP) produced by a worker.',
      '',
      'The user requested an audit-point review. The brief was:',
      '',
      brief,
      '',
      ...
      'Flag findings that drift from the brief or whose evidence does not',
