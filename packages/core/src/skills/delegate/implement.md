...
Implement EXACTLY what the brief asks for — the smallest complete change, no gaps and no extras.

**Completion test:** a reviewer reading your diff alongside the brief answers "yes, you finished it" (no silent partial fix) and "no, you touched nothing extra" (no scope creep) — both cleanly.
