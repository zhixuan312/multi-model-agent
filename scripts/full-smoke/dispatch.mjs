...
export function buildRequest(spec, ctx) {
  ...
  switch (spec.id) {
    ...
    case 3:  return { route: 'research', body: { question: 'Common strategies for guarding division-by-zero in TypeScript?' } };
    ...
    case 'seed': return { route: 'delegate', body: { tasks: [ T('Read the file at /nonexistent/zzz and transcribe it verbatim. Do not create any file.', { timeoutMs: 1, done: 'transcribed' }) ] } };
