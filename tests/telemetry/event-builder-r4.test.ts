    ...
    const ctx: any = {
      ...
      runResult: {
        ...
        stageStats: {
          ...
          review: { stage: 'review', entered: true, durationMs: 3000, costUSD: 0.001, agentTier: 'complex', modelFamily: 'claude', model: 'claude-haiku', verdict: 'approved', roundsUsed: 1 },
          rework: { stage: 'rework', entered: true, durationMs: 5000, costUSD: 0.03, agentTier: 'standard', modelFamily: 'claude', model: 'claude-sonnet' },
