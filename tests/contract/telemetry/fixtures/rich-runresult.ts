...
export function richRunResult(): RunResult {
  return {
    ...
    stageStats: {
      implementing:    { stage: 'implementing',    entered: true, durationMs: 30000, costUSD: 0.03, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 1000, totalIdleMs: 5000, activityEvents: 20, inputTokens: 500, outputTokens: 100, cachedTokens: 50, cachedReadTokens: 30, cachedNonReadTokens: 20, reasoningTokens: 25, round: 1, turnCount: 7, toolCallCount: 4, filesReadCount: 2, filesWrittenCount: 1 },
      spec_review:     { stage: 'spec_review',     entered: true, durationMs: 5000,  costUSD: 0.005, agentTier: 'complex', modelFamily: 'openai', model: 'claude-sonnet', maxIdleMs: 500,  totalIdleMs: 1000, activityEvents: 4,  inputTokens: 200, outputTokens: 50,  cachedTokens: 20, cachedReadTokens: 12, cachedNonReadTokens: 8, reasoningTokens: 10, round: 1, turnCount: 1, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1, verdict: 'approved' as const, roundsUsed: 2 },
      quality_review:  { stage: 'quality_review',  entered: true, durationMs: 5000,  costUSD: 0.005, agentTier: 'complex', modelFamily: 'openai', model: 'claude-sonnet', maxIdleMs: 500,  totalIdleMs: 1000, activityEvents: 4,  inputTokens: 200, outputTokens: 50,  cachedTokens: 20, cachedReadTokens: 12, cachedNonReadTokens: 8, reasoningTokens: 10, round: 1, turnCount: 1, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1, verdict: 'approved' as const, roundsUsed: 2 },
      spec_rework:     { stage: 'spec_rework',     entered: true, durationMs: 3000,  costUSD: 0.003, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 200,  totalIdleMs: 500,  activityEvents: 3,  inputTokens: 100, outputTokens: 30,  cachedTokens: 5,  cachedReadTokens: 3,  cachedNonReadTokens: 2, reasoningTokens: 5,  round: 1, turnCount: 2, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1 },
      quality_rework:  { stage: 'quality_rework',  entered: true, durationMs: 3000,  costUSD: 0.003, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 200,  totalIdleMs: 500,  activityEvents: 3,  inputTokens: 100, outputTokens: 30,  cachedTokens: 5,  cachedReadTokens: 3,  cachedNonReadTokens: 2, reasoningTokens: 5,  round: 1, turnCount: 2, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1 },
      diff_review:     { stage: 'diff_review',     entered: true, durationMs: 1000,  costUSD: 0.001, agentTier: 'complex', modelFamily: 'openai', model: 'claude-sonnet', maxIdleMs: 100,  totalIdleMs: 200,  activityEvents: 2,  inputTokens: 50,  outputTokens: 10,  cachedTokens: 1,  cachedReadTokens: 1,  cachedNonReadTokens: 1, reasoningTokens: 1,  round: 1, turnCount: 1, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1, verdict: 'approved' as const, roundsUsed: 1 },
      verifying:       { stage: 'verifying',       entered: true, durationMs: 2000,  costUSD: 0.001, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 100,  totalIdleMs: 200,  activityEvents: 2,  inputTokens: null, outputTokens: null, cachedTokens: null, cachedReadTokens: null, cachedNonReadTokens: null, reasoningTokens: null, round: 1, turnCount: null, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1, outcome: 'passed' as const, skipReason: null },
      committing:      { stage: 'committing',      entered: true, durationMs: 500,   costUSD: 0.001, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 50,   totalIdleMs: 100,  activityEvents: 1,  inputTokens: null, outputTokens: null, cachedTokens: null, cachedReadTokens: null, cachedNonReadTokens: null, reasoningTokens: null, round: 1, turnCount: null, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1 },
    },
