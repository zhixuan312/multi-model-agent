...
export function richRunResult(): RuntimeRunResult {
  return {
    ...
    stageStats: {
      implementing: { stage: 'implementing', entered: true, durationMs: 30000, costUSD: 0.03, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 1000, totalIdleMs: 5000, activityEvents: 20, inputTokens: 500, outputTokens: 100, cachedReadTokens: 30, cachedNonReadTokens: 25, round: 1, turnCount: 7, filesWrittenCount: 1 },
      review:       { stage: 'review',       entered: true, durationMs: 10000, costUSD: 0.010, agentTier: 'complex',  modelFamily: 'openai', model: 'claude-sonnet', maxIdleMs: 500, totalIdleMs: 2000, activityEvents: 8, inputTokens: 400, outputTokens: 100, cachedReadTokens: 24, cachedNonReadTokens: 20, round: 1, turnCount: 2, filesWrittenCount: 0, verdict: 'approved' as const, roundsUsed: 2 },
      rework:       { stage: 'rework',       entered: true, durationMs: 6000,  costUSD: 0.006, agentTier: 'complex',  modelFamily: 'openai', model: 'claude-sonnet', maxIdleMs: 400, totalIdleMs: 1000, activityEvents: 6, inputTokens: 200, outputTokens: 60, cachedReadTokens: 6, cachedNonReadTokens: 10, round: 1, turnCount: 4, filesWrittenCount: 2 },
      annotating:   { stage: 'annotating',   entered: true, durationMs: 2000,  costUSD: 0.001, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 100, totalIdleMs: 200, activityEvents: 2, inputTokens: null, outputTokens: null, cachedReadTokens: null, cachedNonReadTokens: null, round: 1, turnCount: null, filesWrittenCount: 1, outcome: 'passed' as const, skipReason: null },
      committing:   { stage: 'committing',   entered: true, durationMs: 500,   costUSD: 0.001, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 50,  totalIdleMs: 100, activityEvents: 1, inputTokens: null, outputTokens: null, cachedReadTokens: null, cachedNonReadTokens: null, round: 1, turnCount: null, filesWrittenCount: 1 },
    },
