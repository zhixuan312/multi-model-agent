...
export function richRunResult(): RunResult {
  return {
    ...
    stageStats: {
      ...
      spec_review:     { stage: 'spec_review',     entered: true, durationMs: 5000,  costUSD: 0.005, agentTier: 'standard', modelFamily: 'openai', model: 'gpt-5', maxIdleMs: 500,  totalIdleMs: 1000, activityEvents: 4,  inputTokens: 200, outputTokens: 50,  cachedTokens: 20, reasoningTokens: 10, turnCount: 1, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1, verdict: 'approved' as const, roundsUsed: 2 },
    ...
    models: { implementer: 'gpt-5', specReviewer: 'gpt-5', qualityReviewer: 'gpt-5' },
