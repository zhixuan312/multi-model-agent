...
export function richRunResult(): RunResult {
  return {
    ...
    stageStats: {
      ...
      spec_review:     { stage: 'spec_review',     entered: true, durationMs: 5000,  costUSD: 0.005, agentTier: 'complex', modelFamily: 'openai', model: 'claude-sonnet', maxIdleMs: 500,  totalIdleMs: 1000, activityEvents: 4,  inputTokens: 200, outputTokens: 50,  cachedTokens: 20, reasoningTokens: 10, turnCount: 1, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1, verdict: 'approved' as const, roundsUsed: 2 },
      quality_review:  { stage: 'quality_review',  entered: true, durationMs: 5000,  costUSD: 0.005, agentTier: 'complex', modelFamily: 'openai', model: 'claude-sonnet', maxIdleMs: 500,  totalIdleMs: 1000, activityEvents: 4,  inputTokens: 200, outputTokens: 50,  cachedTokens: 20, reasoningTokens: 10, turnCount: 1, toolCallCount: 1, filesReadCount: 1, filesWrittenCount: 1, verdict: 'approved' as const, roundsUsed: 2 },
