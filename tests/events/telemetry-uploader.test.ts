...
const buildOpts = () => ({ toolMode: 'full' as const, verifyCommandPresent: false, implementerModel: 'claude-sonnet-4-6', implementerTier: 'standard' as const, mainModelFamily: 'claude' });
