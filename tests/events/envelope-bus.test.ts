...
const seed = { taskId: 't', batchId: 'b', taskIndex: 0, route: 'delegate' as const, agentType: 'standard' as const, client: 'claude-code', mainModel: 'm', cwd: '/tmp', reviewPolicy: 'full' as const };
